...
import { View, StyleSheet, ActivityIndicator, Dimensions, FlatList, InteractionManager, BackHandler, Pressable , TextInput as RNTextInput} from 'react-native';
...
const SeriesItem = React.memo(function SeriesItem({
  ...
  return (
    <View style={[S.seriesItemWrapper, { width: itemWidth }]}>
      ...
      >
        {(focused) => (
          <View style={[S.seriesCardContainer, focused && S.seriesCardContainerFocused]}>
            <View
              style={[
                S.posterFrame,
                { height: posterHeight },
...
export default function SeriesScreen() {
  ...
  const renderRow = useCallback(
    ...
    [chunkedSeries.length, numColumns, itemWidth, posterHeight, ROW_HEIGHT, handleSeriesPress, handleSeriesFocus, handleFavoritePress, favorites.series, parentalVersion]
  );
